...
def _default_config_template() -> str:
    return "\n".join(
        [
            ...
            "#",
            "# env: define variables resolved in paths and uri below.",
            "#   Variables are workspace-scoped (not shell env vars).",
            "#",
            "# uri (required): absolute path or $VAR path to the vector store.",
            "# Relative paths are NOT allowed.",
            "",
            "env:",
            "  SMAK_DATA: /path/to/your/smak_stores",
            "  # DDI_ROOT_PATH: /path/to/project/root",
            "",
            "indices:",
            "  - name: source_code",
